  ...
  <NuxtLayout>
    <div class="error-content">
      <template v-if="isNotFoundError">
        <svg xmlns="http://www.w3.org/2000/svg" width="208" height="140" viewBox="0 0 208 140" fill="none" class="error-icon">
          <path
      ...
      <div v-if="!isNotFoundError" class="error-details">
        <dl>
          <dt>Status</dt>
          <dd>{{ error.status }}</dd>
      ...
      <Button
        ...
        text
      >
        <NuxtLink to="/" class="back-to-home-button" :class="slotProps.class" @click="clearError()">
